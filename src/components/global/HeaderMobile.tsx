...
const HeaderMobile = () => {
  ...
  return (
    ...
    >
      ...
      <motion.ul variants={variants} className="absolute grid w-full gap-3 px-10 py-16 h-fit">
...
const Path = (props: any) => <motion.path fill="transparent" strokeWidth="2" stroke="hsl(0, 0%, 18%)" strokeLinecap="round" {...props} />;
